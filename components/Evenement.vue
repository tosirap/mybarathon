<template>
  <div class="container mx-auto py-6">
    ...
    <template v-for="(bar, index) in barList" :key="index">
      <section class="mb-4 border rounded-lg shadow-sm">
        <button
          name="expand_bar_informations"
          aria-label="Ouvrir les informations du bar"
        ...
        <transition name="fade">
          <div v-if="activeIndex === index" class="p-4 bg-white">
            <Suspense>
              ...
              <template #fallback>
                <div
                  class="bar-image-wrapper bg-gray-200 animate-pulse"
                  style="height: 16rem; border-radius: 0.5rem"
                />
              </template>
            </Suspense>
            ...
            <Suspense>
              ...
              <template #fallback>
                <div class="mb-3 h-48 bg-gray-200 rounded-md animate-pulse" />
              </template>
            </Suspense>
            ...
            <div v-if="bar.drinks && bar.drinks.length > 0" class="mb-6">
              ...
              <template v-for="(drink, i) in bar.drinks" :key="i">
                <div
            ...
            <div v-if="bar.foods && bar.foods.length > 0" class="mb-6">
              ...
              <template v-for="(food, i) in bar.foods" :key="i">
                <div
                  class="flex justify-between items-center p-3 bg-gray-50 rounded-lg border border-gray-200 hover:bg-gray-100 transition-colors"
                >
                  <span class="font-medium text-gray-800">{{
            ...
            <div v-if="bar.benefits && bar.benefits.length > 0">
              ...
              <template v-for="(benefit, i) in bar.benefits" :key="i">
                <span
