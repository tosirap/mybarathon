<template>
    <div class="content">
      ...
      <h4 class="centered"> Les 10 commandements du Beer Pong</h4>
      <ol class="rules">
        <li> Chaque joueur d'une équipe lance 1 balle. Quand tous les joueurs d'une équipe ont joué, on passe à l'équipe suivante. </li>
